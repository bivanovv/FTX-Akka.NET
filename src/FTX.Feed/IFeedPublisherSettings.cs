...
/// <summary>
///     The settings used by the <see cref="FtxFeedPublisher" />
/// </summary>
public interface IFeedPublisherSettings
{
    FtxRealtimeFeedClient Client { get; set; }
...
public sealed class DefaultFeedPublisherSettings : IFeedPublisherSettings
{
    ...
    /// <summary>
    ///     The default connection timeout we're willing to tolerate for the FTX API
    /// </summary>
    ...
    public FtxRealtimeFeedClient Client { get; set; }
